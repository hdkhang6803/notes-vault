...
### 1.2.2. Why Previous Approaches Fall Short
...
### 1.2.3. What KARMA Specifically Addresses
...
## 1.4. Pipeline
### 1.4.1. Step 1: Ingestion Agent (IA)
...
---
### 1.4.3. Step 3: Summarizer Agent (SA)
...
---
### 1.4.4. Step 4: Entity Extraction Agent (EEA)
...
---
### 1.4.5. Step 5: Relationship Extraction Agent (REA)
...
### 1.4.6. Step 6: Schema Alignment Agent (SAA)
...
---
### 1.4.7. Step 7: Conflict Resolution Agent (CRA)
...
### 1.4.8. Step 8: Evaluator Agent (EA)
